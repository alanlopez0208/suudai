class Datos {
  ...
  String obtenerBusqueda(String busqueda) {
    Map<int, Map<String, String>>? animalData =
        animalList.firstWhere((map) => map.containsKey(_index));
