...
class InfoPresentation extends StatefulWidget {
  const InfoPresentation({super.key});

  @override
  State<InfoPresentation> createState() => _InfoPresentationState();
}

class _InfoPresentationState extends State<InfoPresentation> {
  int currentPage = 0;
                    ...
                    children: <Widget>[
                      ...
                      PageView(
                        ...
                        children: List.generate(
                          3,
                          (index) => pagePhoto(
                              foto: "assets/images/noImage.png", index: index),
                        ),
                      )
                    ],
                  ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod sagittis ligula, eget gravida mi tempus in. Nulla id convallis eros. In hac habitasse platea dictumst. Ut eu purus nec eros iaculis fringilla eget in lorem. Nunc in metus eu quam pellentesque viverra. Nulla facilisi. Donec ultricies, dolor nec sollicitudin gravida, lorem odio efficitur nibh, vitae venenatis dui odio a quam. ",
                        ...
                        SizedBox(
                          ...
                          child: GoogleMap(
                            ...
                            circles: Set.from(List.generate(
                                gorrion.ubicaciones.length, (index) {
                              return Circulo(
                                circleId:
                                    CircleId("${gorrion.ubicaciones.length}"),
                                center: gorrion.ubicaciones[index],
                              );
                            })),
                          ),
                        ),
